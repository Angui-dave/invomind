...
export const PRICING_PLANS: PricingPlan[] = [
  {
    ...
    description: "Pour émettre vos premières factures",
    features: [
      "10 factures par mois",
      "Clients illimités",
      "Portail client",
      "Dépenses, catalogue et rapports",
      "Relances manuelles",
    ],
    limitLabel: "10 factures par mois",
  },
  {
    id: "pro",
    name: "Pro",
    price: 15_000,
    priceLabel: "15 000 XOF/mois",
    description: "Pour encaisser et relancer sans friction",
    features: [
